...
<%
    ...
    if (epersonForm != null)
    {
        ...
        //secondName = epersonService.getMetadataFirstValue(epersonForm, "eperson", "secondname", null, Item.ANY);
...
%>
    ...
    <%--
    <div class="form-group">
		<label class="col-md-offset-3 col-md-2 control-label" for="tsecond_name"><fmt:message key="jsp.register.profile-form.sname.field"/></label>
        <div class="col-md-3"><input class="form-control" type="text" name="metadata[secondname]" id="tsecond_name" size="40" value=""/></div>
	</div>--%>
